class AppLocale {
  static final Map<String, Map<String, String>> _values = {
    'EN': {
      ...
      'try_again': 'Try Again',
      'retry_wrong': 'Retry Wrong Questions',
      'retry_wrong_count': 'wrong',
    ...
    'MR': {
      ...
      'retry_wrong': 'चुकीचे प्रश्न पुन्हा सोडवा',
      'retry_wrong_count': 'चुकीचे',
    ...
    'HI': {
      ...
      'retry_wrong': 'गलत प्रश्न फिर हल करें',
      'retry_wrong_count': 'गलत',
